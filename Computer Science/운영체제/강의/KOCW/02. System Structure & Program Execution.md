...
![컴퓨터 시스템 구조](E:\develop\TIL\Computer Science\운영체제\강의\KOCW\사진 첨부\컴퓨터 시스템 구조.png)

컴퓨터는 CPU로 이루어진 컴퓨터와 I/O device들로 구성되어 있음  

<br>

![컴퓨터 시스템 구조2](E:\develop\TIL\Computer Science\운영체제\강의\KOCW\사진 첨부\컴퓨터 시스템 구조2.png)
